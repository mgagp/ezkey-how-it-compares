...
| Field | Value |
| --- | --- |
| URL | [https://www.shibboleth.net/products/identity-provider/](https://www.shibboleth.net/products/identity-provider/) |
| Source | [https://git.shibboleth.net/view/?p=java-identity-provider.git](https://git.shibboleth.net/view/?p=java-identity-provider.git) |
